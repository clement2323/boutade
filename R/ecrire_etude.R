...
#' 
#' @param dir_etude Chemin vers le dossier de l'étude
#' @param dir_input Chemin vers le dossier d'entrée contenant les fichiers de données. Par défaut "input/"
#' @param nom_fichier_demandes Nom du fichier CSV contenant les demandes d'analyse. Par défaut "fichier_demandes.csv"
...
#' @param nom_code_setup Nom du fichier de setup. Par défaut "Setup.R"
#' @param nom_code_preparation Nom du fichier de préparation. Par défaut "Preparation_donnees.R"
#' @param dir_output Chemin vers le dossier de sortie. Par défaut "output/"
#' @param nom_rapport Nom du fichier rapport Rmd à générer. Par défaut "rapport.Rmd"
#' @param use_ia Booléen indiquant si utiliser l'IA pour l'analyse. Par défaut FALSE
#' @param fonction_ask_ia Fonction à utiliser pour les requêtes IA. Par défaut NULL
