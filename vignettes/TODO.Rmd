...
## TO DO 
- generer un tableaud e bord aussi au meme model que le  4 pages esane partie sous partie  = onglet sousonglet
- refaire la fonction controler incohérence (vérif si nom onglet etc.. existe)
- prompt inclure les unités des variables grace aux parmas unite unite unite
