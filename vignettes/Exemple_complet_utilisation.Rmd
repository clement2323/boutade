...
liste_info_chunk <- pblapply(1:nrow(table_demandes_rmd), function(i){ generer_figure_from_demande(table_demandes_rmd[i,])
}
)
```
```{r}
...
# gestion excel ok <-
liste_tables_params <- lapply(1:nrow(table_demandes), function(i)renvoyer_table_from_demande(table_demandes[i,],metadonnees_tables))
